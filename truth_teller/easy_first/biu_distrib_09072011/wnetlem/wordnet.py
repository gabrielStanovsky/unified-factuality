...
from nltk_stuff import CorpusReader, binary_search_file as _binary_search_file, FreqDist
...
WN = WordNetCorpusReader(os.path.join(os.path.dirname(__file__),"data"))
######################################################################
# Demo
######################################################################
